 ...
 */
class Kidspress_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Kidspress_Dropdown_Category_Control extends WP_Customize_Control {
...
class Kidspress_Note_Control extends WP_Customize_Control {
...
class Kidspress_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Kidspress_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="kidspress-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Kidspress_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Kidspress_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="kidspress-sortable-list">
      ...
      ?>
        ...
        <li>
            <input class="kidspress-sortable-input sortable-hideme" name="<?php echo esc_attr( $value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
            <span class ="menu-item-handle sortable-span"> <?php echo esc_attr( $choices[$value] ); ?> </span>
          <i class="dashicons dashicons-menu kidspress-drag-handle"></i>
        </li>
        ...
        <li class="sortable-hideme">
          <input class="kidspress-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
class Kidspress_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="kidspress-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'kidspress' ); ?>" class="kidspress-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
...
Class Kidspress_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @since  1.0.0
 */
class Kidspress_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
