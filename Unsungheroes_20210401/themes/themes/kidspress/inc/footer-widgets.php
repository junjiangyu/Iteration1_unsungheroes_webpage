...
class Kidspress_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'kidspress';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'kidspress' ), $i ),
...
// Initialize.
$kidspress_footer_widgets = new Kidspress_Footer_Widgets();
