	...
	<?php if( get_theme_mod( 'kindergarten_education_metafields_date',true) != '' || get_theme_mod( 'kindergarten_education_metafields_author',true) != '' || get_theme_mod( 'kindergarten_education_metafields_comment',true) != '') { ?>
		<div class="metabox py-2 px-3 mb-3">
			<?php if( get_theme_mod( 'kindergarten_education_metafields_date',true) != '') { ?>
				<i class="<?php echo esc_attr(get_theme_mod('kindergarten_education_date_icon','far fa-calendar-alt')); ?>"></i><span class="entry-date mr-3"><a href="<?php echo esc_url( get_day_link( $archive_year, $archive_month, $archive_day)); ?>" class="py-3 px-1"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span><?php echo esc_html( get_theme_mod('kindergarten_education_single_post_meta_seperator') ); ?>
			<?php }?>
			<?php if( get_theme_mod( 'kindergarten_education_metafields_author',true) != '') { ?>
				<i class="<?php echo esc_attr(get_theme_mod('kindergarten_education_post_author_icon','fas fa-user')); ?>"></i><span class="entry-author mr-3"><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>" class="py-3 px-1"><?php the_author(); ?><span class="screen-reader-text"><?php the_title(); ?></span></a></span><?php echo esc_html( get_theme_mod('kindergarten_education_single_post_meta_seperator') ); ?>
			<?php }?>
			<?php if( get_theme_mod( 'kindergarten_education_metafields_comment',true) != '') { ?>
				<i class="<?php echo esc_attr(get_theme_mod('kindergarten_education_post_comment_icon','fas fa-comments')); ?>"></i><span class="entry-comments mr-3"> <?php comments_number( __('0 Comment', 'kindergarten-education'), __('0 Comments', 'kindergarten-education'), __('% Comments', 'kindergarten-education') ); ?></span>
			<?php }?>
		</div>
	<?php }?>
