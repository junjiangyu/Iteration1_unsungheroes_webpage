...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
  <div class="row m-0">
    ...
    <div class="col-lg-10 col-md-10 inner-box p-1 mb-2">
      ...
      <h2 class="section-title text-left py-1"><a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php echo the_title_attribute(); ?>"><?php the_title();?><span class="screen-reader-text"><?php the_title(); ?></span></a></h2>   
      <div class="new-text">
      ...
      <div class="row inner-box-cat-tag m-1">
        ...
        <div class="col-lg-6 col-md-6">
          <?php if( get_theme_mod('kindergarten_education_button_text','View More') != ''){ ?>
            <div class="postbtn text-md-left text-right my-4">
