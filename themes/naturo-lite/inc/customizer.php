...
function naturo_lite_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section(
        'logo_sec',
        array(
            'title' => __('Logo (PRO Version)', 'naturo-lite'),
            'priority' => 1,
 			'description' => sprintf( __( 'Logo Settings available in<br /> %s.', 'naturo-lite' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( '"'.SKT_PRO_THEME_URL.'"' ), __( 'PRO Version', 'naturo-lite' )
						)
					),			
        )
    );  
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control($wp_customize,'color_scheme',array(
			'label' => __('Color Scheme','naturo-lite'),
 			'description' => sprintf( __( 'More color options in <br /> %s.', 'naturo-lite' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( '"'.SKT_PRO_THEME_URL.'"' ), __( 'PRO Version', 'naturo-lite' )
						)
					),				
			'section' => 'colors',
...
// Home Boxes 	
	$wp_customize->add_section('page_boxes',array(
		'title'	=> __('Homepage Boxes','naturo-lite'),
 			'description' => sprintf( __( 'Featured Image Dimensions : ( 61 X 46 )<br/> Select Featured Image for these pages <br /> How to set featured image %s', 'naturo-lite' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( '"'.SKT_THEME_FEATURED_SET_VIDEO_URL.'"' ), __( 'Click Here ?', 'naturo-lite' )
						)
					),
		'priority'	=> null
	));	
	...
	$wp_customize->add_control('page-setting1',array(
			'type'	=> 'dropdown-pages',
			'label'	=> __('Select page for box one:','naturo-lite'),
			'section'	=> 'page_boxes'	
	));
	...
	$wp_customize->add_control('page-setting2',array(
			'type'	=> 'dropdown-pages',
			'label'	=> __('Select page for box two:','naturo-lite'),
			'section'	=> 'page_boxes'
	));
	...
	$wp_customize->add_control('page-setting3',array(
			'type'	=> 'dropdown-pages',
			'label'	=> __('Select page for box three:','naturo-lite'),
			'section'	=> 'page_boxes'
	));	
	...
	$wp_customize->add_control('page-setting4',array(
			'type'	=> 'dropdown-pages',
			'label'	=> __('Select page for box four:','naturo-lite'),
			'section'	=> 'page_boxes'
	));	
 
// Home Boxes
	$wp_customize->add_section('slider_section',array(
		'title'	=> __('Slider Settings','naturo-lite'),
		'description' => sprintf( __( 'Slider Image Dimensions ( 1400 X 544 )<br/> Select Featured Image for these pages <br /> How to set featured image <a href="%1$s" target="_blank">Click Here ?</a><br/><br/> More slider settings available in <a href="%2$s" target="_blank">PRO Version</a>', 'naturo-lite' ),
...
// Slider Section	
	...
	$wp_customize->add_control(   new WP_Customize_Image_Control( $wp_customize, 'slide_image1', array(
            'label' => __('Slide Image 1 (1400x544)','naturo-lite'),
	...
	$wp_customize->add_setting('slide_title1',array(
			'default'	=> __('We Create Wordpress Theme','naturo-lite'),
			'sanitize_callback' => 'sanitize_text_field',
	));
	$wp_customize->add_control( 'slide_title1', array(	
			'label'	=> __('Slide title 1','naturo-lite'),
			'section'	=> 'slider_section',
			'setting'	=> 'slide_title1'
	));
	$wp_customize->add_setting('slide_desc1',array(
		'default'	=> __('We are a group of experienced designers and developers. We set new standards in user experience & make future happen.','naturo-lite'),
		'sanitize_callback'	=> 'sanitize_text_field'	
	));
	$wp_customize->add_control(	new WP_Customize_Textarea_Control( $wp_customize,'slide_desc1', array(
				'label'	=> __('Slider description  1','naturo-lite'),
				'section'	=> 'slider_section',
				'setting'	=> 'slide_desc1'
			)
		)
	...
	$wp_customize->add_control('slide_link1',array(
			'label'	=> __('Slide link 1','naturo-lite'),
			'section'	=> 'slider_section',
			'setting'	=> 'slide_link1'
	));	
	// Slide Image 2
	...
	$wp_customize->add_control(	new WP_Customize_Image_Control(	$wp_customize, 'slide_image2', array(
				'label'	=> __('Slide image 2','naturo-lite'),
				'section'	=> 'slider_section',
	...
	$wp_customize->add_setting('slide_title2',array(
			'default'	=> __('We Create Wordpress Responsive Theme','naturo-lite'),
			'sanitize_callback' => 'sanitize_text_field',
	));
	$wp_customize->add_control( 'slide_title2', array(	
			'label'	=> __('Slide title 2','naturo-lite'),
			'section'	=> 'slider_section',
	...
	$wp_customize->add_control(	new WP_Customize_Textarea_Control( $wp_customize,'slide_desc2', array(
				'label'	=> __('Slide description 2','naturo-lite'),
				'section'	=> 'slider_section',
				'setting'	=> 'slide_desc2'
			)
		)
	...
	$wp_customize->add_control('slide_link2',array(
		'label'	=> __('Slide link 2','naturo-lite'),
		'section'	=> 'slider_section',
		'setting'	=> 'slide_link2'
	));	
	// Slide Image 3
	...
	$wp_customize->add_control( new WP_Customize_Image_Control(	$wp_customize,'slide_image3', array(
				'label'	=> __('Slide Image 3','naturo-lite'),
				'section'	=> 'slider_section',
	...
	$wp_customize->add_setting('slide_title3',array(
			'default'	=> __('','naturo-lite'),
			'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('slide_title3', array(		
			'label'	=> __('Slide title 3','naturo-lite'),
			'section'	=> 'slider_section',
	...
	$wp_customize->add_control(	new WP_Customize_Textarea_Control($wp_customize,'slide_desc3', array(
				'label'	=> __('Slide Description 3','naturo-lite'),
				'section'	=> 'slider_section',
				'setting'	=> 'slide_desc3'		
			)
		)
	...
	$wp_customize->add_control('slide_link3',array(
			'label'	=> __('Slide link 3','naturo-lite'),
			'section'	=> 'slider_section',
			'setting'	=> 'slide_link3'
	));	
 
	$wp_customize->add_section('social_sec',array(
			'title'	=> __('Social Settings','naturo-lite'),
 			'description' => sprintf( __( 'Add social icons link here.<br />More icon available in %s.', 'naturo-lite' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( '"'.SKT_PRO_THEME_URL.'"' ), __( 'PRO Version', 'naturo-lite' )
						)
					),			
			'priority'		=> null
	));
	...
	$wp_customize->add_control('fb_link',array(
			'label'	=> __('Add facebook link here','naturo-lite'),
			'section'	=> 'social_sec',
			'setting'	=> 'fb_link'
	));	
	...
	$wp_customize->add_control('twitt_link',array(
			'label'	=> __('Add twitter link here','naturo-lite'),
			'section'	=> 'social_sec',
			'setting'	=> 'twitt_link'
	));
	...
	$wp_customize->add_control('gplus_link',array(
			'label'	=> __('Add google plus link here','naturo-lite'),
			'section'	=> 'social_sec',
			'setting'	=> 'gplus_link'
	));
	...
	$wp_customize->add_control('linked_link',array(
			'label'	=> __('Add linkedin link here','naturo-lite'),
			'section'	=> 'social_sec',
			'setting'	=> 'linked_link'
	));
	$wp_customize->add_section('footer_text',array(
			'title'	=> __('Footer Area','naturo-lite'),
			'priority'	=> null,
			'description'	=> __('Add footer copyright text','naturo-lite')
	));
    ...
    $wp_customize->add_control( new Naturo_Lite_Info( $wp_customize, 'cred_section', array(
		'label'	=> __('To modify footer copyright notice without changing your themes code, please upgrade to pro.','naturo-lite'),
        'section' => 'footer_text',
        'settings' => 'naturo_lite_options[credit-info]'
        ) )
    );
	$wp_customize->add_setting('about_title',array(
			'default'	=> __('About Us','naturo-lite'),
			'sanitize_callback'	=> 'sanitize_text_field'
	));
	
	$wp_customize->add_control('about_title',array(
			'label'	=> __('Add about title here','naturo-lite'),
			'section'	=> 'footer_text',
			'setting'	=> 'about_title'
	));
	
	$wp_customize->add_setting('about_description', array(
			'default'	=> __('Sed suscipit mauris nec mauris vulputate, a posuere libero congue. Nam laoreet elit eu erat pulvinar, et efficitur nibh euismod.Nam metus lorem, hendrerit quis ante eget, lobortis elementum neque. Aliquam in ullamcorper quam. Integer euismod ligula in mauris vehic.','naturo-lite'),
			'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(	new WP_Customize_Textarea_Control( $wp_customize,'about_description', array(
				'label'	=> __('Add about description for footer','naturo-lite'),
				'section'	=> 'footer_text',
	...
	$wp_customize->add_section('contact_sec',array(
			'title'	=> __('Contact Details','naturo-lite'),
			'description'	=> __('Add you contact details here','naturo-lite'),
			'priority'	=> null
	));
	
	$wp_customize->add_setting('contact_add',array(
			'default'	=> __('100 King St, Melbourne PIC 4000, Australia','naturo-lite'),
			'sanitize_callback'	=> 'sanitize_text_field'
	));
	
	$wp_customize->add_control(	new WP_Customize_Textarea_Control( $wp_customize, 'contact_add', array(
				'label'	=> __('Add contact address here','naturo-lite'),
				'section'	=> 'contact_sec',
				'setting'	=> 'contact_add'
			)
		)
	...
	$wp_customize->add_setting('contact_no',array(
			'default'	=> __('+123 456 7890','naturo-lite'),
			'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('contact_no',array(
			'label'	=> __('Add contact number here.','naturo-lite'),
			'section'	=> 'contact_sec',
			'setting'	=> 'contact_no'
	));
	...
	$wp_customize->add_control('contact_mail',array(
			'label'	=> __('Add you email here','naturo-lite'),
			'section'	=> 'contact_sec',
	...
	$wp_customize->add_section(
        'theme_layout_sec',
        array(
            'title' => __('Layout Settings (PRO Version)', 'naturo-lite'),
            'priority' => null,
 			'description' => sprintf( __( 'Layout Settings available in <br />%s.', 'naturo-lite' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( '"'.SKT_PRO_THEME_URL.'"' ), __( 'PRO Version', 'naturo-lite' )
						)
					),			
        )
    );  
	...
	$wp_customize->add_section(
        'theme_font_sec',
        array(
            'title' => __('Fonts Settings (PRO Version)', 'naturo-lite'),
            'priority' => null,
 			'description' => sprintf( __( 'Font Settings available in <br />%s.', 'naturo-lite' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( '"'.SKT_PRO_THEME_URL.'"' ), __( 'PRO Version', 'naturo-lite' )
						)
					),			
        )
    );  
    ...
    $wp_customize->add_section(
        'theme_doc_sec',
        array(
            'title' => __('Documentation &amp; Support', 'naturo-lite'),
            'priority' => null,
 			'description' => sprintf( __( 'For documentation and support check this link : <br />%s.', 'naturo-lite' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( '"'.SKT_THEME_DOC.'"' ), __( 'Naturo Documentation', 'naturo-lite' )
						)
					),							
        )
    );  
