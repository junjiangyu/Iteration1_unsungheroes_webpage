...
<div class="header">
  ...
  <div class="container">  
     ...
     <strong><?php echo esc_html('Phone:', 'naturo-lite');?></strong>
     <?php echo esc_attr( get_theme_mod('contact_no', '+123 456 7890', 'naturo-lite' )); ?>
     <?php } ?>&nbsp;&nbsp;&nbsp;
     <?php if ( '' != get_theme_mod( 'contact_mail' ) ) { ?>
	 <strong><?php echo esc_html('Email:', 'naturo-lite');?></strong>
     <a href="mailto:<?php echo sanitize_email(get_theme_mod('contact_mail','contact@company.com')); ?>"><?php echo esc_html(get_theme_mod('contact_mail','contact@company.com')); ?></a>
	 <?php } ?>    
     ...
     <div class="clear"></div>
        ...
        <div class="header-inner">
                ...
                <div class="toggle">
                <a class="toggleMenu" href="#"><?php esc_html_e('Menu','naturo-lite'); ?></a>
                </div><!-- toggle -->
                <div class="nav">                  
...
<section id="home_slider">
			...
			if( $slAr > 0 ){
                ...
                foreach( $slideno as $sln ){ ?>
                    ...
                    <h2><a href="<?php echo esc_url(get_theme_mod('slide_link'.$sln,'#link'.$sln)); ?>"><?php echo esc_html(get_theme_mod('slide_title'.$sln, __('We Create Wordpress Theme','naturo-lite').$sln)); ?></a></h2>
                    <p><?php  echo esc_attr(get_theme_mod('slide_desc'.$sln, __('We are a group of experienced designers and developers. We set new standards in user experience & make future happen.','naturo-lite').$sln)); ?></p>
                    </div>
                    </div><?php 
                } ?>
                </div>
...
<?php
        ...
        <div class="one_fourth <?php if($bx%4==0){ ?>last_column<?php } ?>">
            ...
            <?php the_content(); ?>
            <a href="<?php the_permalink(); ?>"><p class="ReadMore"><?php esc_html_e('Read More', 'naturo-lite');?></p></a>
        </div>
        <!-- feature-box -->
        <?php if($bx%4==0) { ?>
        <div class="clear"></div>
        ...
        <a href="<?php echo esc_url('#');?>"><div class="one_fourth <?php if($bx%4==0){ ?>last_column<?php } ?>">
            ...
            <h3><?php esc_html_e('Page Title','naturo-lite'); ?> <?php echo esc_attr($bx); ?></h3>
            <p><?php esc_html_e('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas imperdiet ex at mauris varius interdum. Fusce mattis gravida libero, nec sollicitudin ad ti ku.','naturo-lite');?></p>
            <p class="ReadMore"><?php esc_html_e('Read More', 'naturo-lite');?></p>
        </div></a>
        <!-- feature-box -->
        <?php if($bx%4==0) { ?>
        <div class="clear"></div>
