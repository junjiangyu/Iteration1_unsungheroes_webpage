        	 ...
        	 <div class="blog-post">
                    ...
                    if ( have_posts() ) :
                        ...
                        // Previous/next post navigation.
							...
							'mid_size' => 2,
							'prev_text' => __( 'Back', 'naturo-lite' ),
							'next_text' => __( 'Onward', 'naturo-lite' ),
						) );
...
<?php else: ?>
 ...
 <section id="FrontBlogPost">
  <div class="container">
  <h1 class="entry-title"><center><?php esc_html_e('Latest Posts','naturo-lite'); ?></center></h1>       
	  ...
	  ?>			
        <?php while( $postquery->have_posts() ) : $postquery->the_post(); ?><?php $p++; ?>      
            <div class="blog_lists BlogPosts <?php if( $p%3==0 ){?>last_column<?php } ?>">        
              ...
              <?php the_content(); ?>
              <a class="MoreLink" href="<?php the_permalink(); ?>"><?php esc_html_e('Read more &raquo;','naturo-lite');?></a> 
              <div class="clear"></div>
          </div>       
        <?php endwhile; ?> 
        <?php 
