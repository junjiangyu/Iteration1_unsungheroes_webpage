...
function naturo_lite_setup() {
	...
	load_theme_textdomain( 'naturo-lite', get_template_directory() . '/languages' );
	...
	register_nav_menu( 'primary', esc_attr__( 'Primary Menu', 'naturo-lite' ) );
...
function naturo_lite_widgets_init() {	
	...
	register_sidebar( array(
		'name'          => esc_attr__( 'Blog Sidebar', 'naturo-lite' ),
		'description'   => esc_attr__( 'Appears on blog page sidebar', 'naturo-lite' ),
		'id'            => 'sidebar-1',
		'before_widget' => '',		
...
function naturo_lite_font_url(){
		...
		*/
		$roboto = _x('on','Roboto:on or off','naturo-lite');
